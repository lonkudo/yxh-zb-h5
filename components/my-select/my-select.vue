		...
		>
			<view class="u-select">
				<view class="u-select__header" @touchmove.stop.prevent="">
					<view
						class="u-select__header__cancel u-select__header__btn fs-20"
					...
					<view class="u-select__header__title fs-30 fc-b-9">
						{{ title }}
					</view>
					<view
						class="u-select__header__confirm u-select__header__btn fs-20"
