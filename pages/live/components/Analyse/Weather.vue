...
<script>
	let weatherPics = [
		{
			name: 'Partly cloudy',
			pic: require('@/static/styles/png/weather-cloudy.png'),
		},
		{ name: 'Cloudy', pic: require('@/static/styles/png/weather-cloudy.png') },
		{
			name: 'Partly cloudy/rain',
			pic: require('@/static/styles/png/weather-raining.png'),
		},
		{ name: 'Snow', pic: require('@/static/styles/png/weather-snowy.png') },
		{ name: 'Sunny', pic: require('@/static/styles/png/weather-sunny.png') },
		{
			name: 'Overcast with rain/partial thunderstorm',
			pic: require('@/static/styles/png/weather-thunder.png'),
		},
		{ name: 'Overcast', pic: require('@/static/styles/png/weather-raining.png') },
		{ name: 'Misty', pic: require('@/static/styles/png/weather-foggy.png') },
		{
			name: 'Overcast and rainy',
			pic: require('@/static/styles/png/weather-drizzle.png'),
		},
		{
		...
		{ name: 'Fog', pic: require('@/static/styles/png/weather-foggy.png') },
	]
